...
<div class="group fixed bottom-6 right-6 z-[100] md:bottom-6 md:right-6 bottom-20 right-4">
	<a
	...
	>
		<!-- Pulsing ring -->
		<span class="absolute inset-0 rounded-full bg-[#25D366] opacity-40 animate-wa-pulse"></span>
		<span class="absolute inset-0 rounded-full bg-[#25D366] opacity-20 animate-wa-pulse" style="animation-delay: 0.4s;"></span>

		<!-- Label (slides in from right on hover) -->
		<span class="mr-3 hidden max-w-0 overflow-hidden whitespace-nowrap rounded-full bg-dark-800 px-4 py-2 text-sm font-medium text-dark-100 shadow-lg transition-all duration-300 group-hover:max-w-[160px] md:block border border-dark-600/60">
			Chat on WhatsApp
		</span>

		<!-- Button -->
		<div class="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl shadow-[#25D366]/30 transition-transform duration-200 group-hover:scale-110">
			<!-- WhatsApp SVG icon -->
